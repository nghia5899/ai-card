                                            ...
                                            children: [
                                              ...
                                              Obx(() =>  Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      border: Border.all(color: controller.isEditImage(0)? Colors.blue : Colors.transparent, width: 2.w)
                                                    ),
                                                    child: Image(
                                                      width: imageWidth,
                                                      height: imageHeight,
                                          ...
                                          child: Stack(
                                            children: [
                                              ...
                                              Obx(() => Container(
                                                    ...
                                                    alignment: Alignment.topCenter,
                                                    decoration: BoxDecoration(
                                                    border: Border.all(color: controller.isEditImage(1)? Colors.blue : Colors.transparent, width: 2.w)
                                                ),
                                                    child: Image(
                                                      width: imageWidth,
                                                      height: imageHeight,
